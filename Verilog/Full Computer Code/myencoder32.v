...
module myencoder32 (
	...
	myencoder32_enc8b10b	myencoder32_enc8b10b_inst(
		.clk(clk),
		.reset_n(reset_n),
		.idle_ins(idle_ins),
		.kin(kin),
...
// Retrieval info:  <NETLIST_SECTION class="altera.ipbu.flowbase.netlist.model.MVCModel"  active_core="myencoder32_enc8b10b" >
...
// Retrieval info:      <PRIVATE name = "p_iptb_top" value="myencoder32"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="myencoder32.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "greybox">
// Retrieval info:      <PRIVATE name = "filename" value="myencoder32_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
